...
export default () => {
  ...
  return (
    <section className="relative py-14 rounded-full">
      ...
      <div
        className="absolute top-0 w-full rounded-xl h-[350px]"
        style={{
          background:
          'linear-gradient(152.92deg, #F2B807 4.54%, #F29F05 34.2%, #F2B807 77.55%)',
        }}
      ></div>
    </section>
  );
